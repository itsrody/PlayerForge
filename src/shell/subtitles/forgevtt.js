 ...
 * via scheduler.yield() so a huge VTT/SRT parse never blocks video playback
 * or paint. Intentionally separate from parseSubtitles so the hot,
 * on-the-fly sync reparse (sync-offset stepper) keeps its zero-await fast
 * path.
 */
