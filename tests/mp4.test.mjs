...
import { isMp4StreamUrl, isMp4ContentType, mediaSafeType, Mp4Router } from "../src/shell/proxy/mp4.js";
import { interposeFetch, interposeXhrPrototype } from "../src/shell/proxy/manifest.js";
