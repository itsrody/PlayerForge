...
// @name         PlayerForge (Vivaldi)
// @namespace    https://github.com/PlayerForge
// @version      0.7.2
// @description  Vivaldi (Chromium 152+) / Tampermonkey 5.5+ (MV3) exclusive HTML5 video player enhancer for desktop and Android with gestures, hotkeys, progress resume, subtitles, and an extensible plugin system
// @author       PlayerForge
