...
// Instant-injection note: @run-at document-start is honored by Violentmonkey
// (and Tampermonkey). PF never assumes the DOM is ready at eval, so it is safe
// under instant injection in either manager.
const banner = `// ==UserScript==
// @name         PlayerForge (Firefox)
// @namespace    https://github.com/PlayerForge
// @version      0.8.0
// @description  Firefox 155+ / Violentmonkey 2.49+ (WebExtension) HTML5 video player enhancer with gestures, hotkeys, progress resume, subtitles, and an extensible plugin system
// @author       PlayerForge
