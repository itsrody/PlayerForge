...
// @version      0.7.1
// @description  Firefox 109+ / Tampermonkey 5.5+ (WebExtension) HTML5 video player enhancer with gestures, hotkeys, progress resume, subtitles, and an extensible plugin system
// @author       PlayerForge
