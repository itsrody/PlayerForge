...
// @name         PlayerForge (Yandex)
// @namespace    https://github.com/PlayerForge
// @version      0.7.2
// @description  Yandex Browser 26.8+ (Chromium 150+) / Tampermonkey 5.5+ (MV3) exclusive HTML5 video player enhancer with gestures, hotkeys, progress resume, subtitles, and an extensible plugin system
// @author       PlayerForge
